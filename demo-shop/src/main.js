...
const legalNotices = {
  ...
  accessibility: { label: 'ACCESSIBILITY', title: 'Accessibility statement', content: `<p>it’s wattϟ aims to make its learning tools and Demo Lab usable by as many people as possible through clear structure, keyboard-friendly interactions, readable contrast, and responsive layouts.</p><h3>Send feedback</h3><p>If something is difficult to use or unavailable with your assistive technology, tell us which page and device you were using.</p><p><a href="mailto:contact@itswatts.com?subject=Demo%20Lab%20accessibility%20feedback">Send accessibility feedback →</a></p>` },
