...
export function HomeDashboard({ onOpenLearn, onOpenPractice, onOpenToolkits, onOpenCareer }: HomeDashboardProps) {
  ...
  return <section className="home-dashboard section" id="about">
    <div className="dashboard-heading"><p className="eyebrow">YOUR QA HUB</p><h2>Choose one<br /><em>useful next step.</em></h2><p>It’s Watts turns real quality-engineering practice into approachable lessons, tools, and experiments you can use in your next sprint.</p></div>
