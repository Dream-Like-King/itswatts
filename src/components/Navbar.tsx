...
type NavbarProps = { onOpenChat: () => void; onOpenLearn: (target?: string) => void; onOpenStory: () => void; onOpenToolkits: () => void; onOpenResources: () => void; onOpenSoftware: () => void }

export function Navbar({ onOpenChat, onOpenLearn, onOpenStory, onOpenToolkits, onOpenResources, onOpenSoftware }: NavbarProps) {
