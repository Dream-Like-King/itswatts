...
type NavbarProps = { onOpenChat: () => void; onOpenLearn: () => void; onOpenCareer: () => void; onOpenPractice: () => void; onOpenStory: () => void; onOpenToolkits: () => void; onOpenResources: () => void; onOpenSoftware: () => void }

export function Navbar({ onOpenChat, onOpenLearn, onOpenCareer, onOpenPractice, onOpenStory, onOpenToolkits, onOpenResources, onOpenSoftware }: NavbarProps) {
