...
export function GrowthHub() {
  ...
  const joinList = (event: FormEvent) => {
    ...
    window.location.href = `mailto:watson.derrick@outlook.com?subject=${encodeURIComponent('It’s Watt launch list')}&body=${encodeURIComponent(`Please add ${value} to the It’s Watt launch list.`)}`
  }
  return <>
