...
export function GrowthHub() {
  ...
  const joinList = (event: FormEvent) => {
    ...
    window.location.href = `mailto:contact@itswatts.com?subject=${encodeURIComponent('it’s Wattϟ launch list')}&body=${encodeURIComponent(`Please add ${value} to the it’s Wattϟ launch list.`)}`
  }
  return <>
