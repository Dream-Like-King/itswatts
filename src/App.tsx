...
import { RagTrainingGuide } from './components/RagTrainingGuide'
import { TestDesignGuide } from './components/TestDesignGuide'
import { AutomationAiGuide } from './components/AutomationAiGuide'
...
function App() {
  ...
  const [isApiGuideOpen, setIsApiGuideOpen] = useState(() => window.location.hash === '#api-testing-guide')
  const [isRagTrainingOpen, setIsRagTrainingOpen] = useState(() => window.location.hash === '#rag-training')
  const [isTestDesignOpen, setIsTestDesignOpen] = useState(() => window.location.hash === '#test-design')
  const [isAutomationAiOpen, setIsAutomationAiOpen] = useState(() => window.location.hash === '#automation-ai')
  const [learnTarget, setLearnTarget] = useState<string | null>(null)
  const openLearn = (target = 'top') => { setLearnTarget(target); window.history.pushState(null, '', '#learn-hub'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsLearnOpen(true) }
  const openStory = () => { window.history.pushState(null, '', '#my-story'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsStoryOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openPractice = () => { window.history.pushState(null, '', '#practice-lab'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsPracticeOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openToolkits = () => { window.history.pushState(null, '', '#qa-toolkits'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsToolkitsOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openResources = () => { window.history.pushState(null, '', '#resources-hub'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsResourcesOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openSoftware = () => { window.history.pushState(null, '', '#qa-software'); setIsCareerOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsSoftwareOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openCareer = () => { window.history.pushState(null, '', '#career-paths'); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsCareerOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openApiGuide = () => { window.history.pushState(null, '', '#api-testing-guide'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsApiGuideOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openRagTraining = () => { window.history.pushState(null, '', '#rag-training'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false); setIsRagTrainingOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openTestDesign = () => { window.history.pushState(null, '', '#test-design'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsAutomationAiOpen(false); setIsTestDesignOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openAutomationAi = () => { window.history.pushState(null, '', '#automation-ai'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const closeFocusedView = () => { window.history.pushState(null, '', '#top'); setIsLearnOpen(false); setIsStoryOpen(false); setIsPracticeOpen(false); setIsToolkitsOpen(false); setIsResourcesOpen(false); setIsSoftwareOpen(false); setIsCareerOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsTestDesignOpen(false); setIsAutomationAiOpen(false) }
  useEffect(() => {
    const syncFocusedView = () => { setIsLearnOpen(window.location.hash === '#learn-hub'); setIsStoryOpen(window.location.hash === '#my-story'); setIsPracticeOpen(window.location.hash === '#practice-lab'); setIsToolkitsOpen(window.location.hash === '#qa-toolkits'); setIsResourcesOpen(window.location.hash === '#resources-hub'); setIsSoftwareOpen(window.location.hash === '#qa-software'); setIsCareerOpen(window.location.hash === '#career-paths'); setIsApiGuideOpen(window.location.hash === '#api-testing-guide'); setIsRagTrainingOpen(window.location.hash === '#rag-training'); setIsTestDesignOpen(window.location.hash === '#test-design'); setIsAutomationAiOpen(window.location.hash === '#automation-ai') }
  ...
  return <>
    ...
    <MobileDock onOpenChat={() => setIsChatOpen(true)} onOpenLearn={openLearn} onOpenCareer={openCareer} onOpenStory={openStory} onOpenPractice={openPractice} onOpenToolkits={openToolkits} onOpenResources={openResources} onOpenSoftware={openSoftware} onNavigateHome={isLearnOpen || isStoryOpen || isPracticeOpen || isToolkitsOpen || isResourcesOpen || isSoftwareOpen || isCareerOpen || isApiGuideOpen || isRagTrainingOpen || isTestDesignOpen || isAutomationAiOpen ? navigateHome : undefined} focusedView={isStoryOpen ? 'story' : isPracticeOpen ? 'practice' : isToolkitsOpen ? 'toolkits' : isResourcesOpen ? 'resources' : isSoftwareOpen ? 'software' : isCareerOpen ? 'career' : isApiGuideOpen || isRagTrainingOpen || isTestDesignOpen || isAutomationAiOpen || isLearnOpen ? 'learn' : null} />
