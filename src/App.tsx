...
function App() {
  ...
  const openLearn = (target = 'top') => { setLearnTarget(target); window.history.pushState(null, '', '#learn-hub'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsApiGuideOpen(false); setIsLearnOpen(true) }
  const openStory = () => { window.history.pushState(null, '', '#my-story'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsStoryOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openPractice = () => { window.history.pushState(null, '', '#practice-lab'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsPracticeOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openToolkits = () => { window.history.pushState(null, '', '#qa-toolkits'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsToolkitsOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openResources = () => { window.history.pushState(null, '', '#resources-hub'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsResourcesOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openSoftware = () => { window.history.pushState(null, '', '#qa-software'); setIsCareerOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsSoftwareOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openCareer = () => { window.history.pushState(null, '', '#career-paths'); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(false); setIsCareerOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const openApiGuide = () => { window.history.pushState(null, '', '#api-testing-guide'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsLearnOpen(false); setIsApiGuideOpen(true); window.requestAnimationFrame(() => window.scrollTo({ top: 0, behavior: 'smooth' })) }
  const closeFocusedView = () => { window.history.pushState(null, '', '#top'); setIsLearnOpen(false); setIsStoryOpen(false); setIsPracticeOpen(false); setIsToolkitsOpen(false); setIsResourcesOpen(false); setIsSoftwareOpen(false); setIsCareerOpen(false); setIsApiGuideOpen(false) }
  useEffect(() => {
    const syncFocusedView = () => { setIsLearnOpen(window.location.hash === '#learn-hub'); setIsStoryOpen(window.location.hash === '#my-story'); setIsPracticeOpen(window.location.hash === '#practice-lab'); setIsToolkitsOpen(window.location.hash === '#qa-toolkits'); setIsResourcesOpen(window.location.hash === '#resources-hub'); setIsSoftwareOpen(window.location.hash === '#qa-software'); setIsCareerOpen(window.location.hash === '#career-paths'); setIsApiGuideOpen(window.location.hash === '#api-testing-guide') }
