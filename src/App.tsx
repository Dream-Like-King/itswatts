...
function App() {
  ...
  const openLearn = (target = 'top') => { setLearnTarget(target); window.history.pushState(null, '', '#learn-hub'); setIsCareerOpen(false); setIsSoftwareOpen(false); setIsResourcesOpen(false); setIsToolkitsOpen(false); setIsPracticeOpen(false); setIsStoryOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false); setIsLearnOpen(true) }
  ...
  const closeFocusedView = () => { window.history.pushState(null, '', '#top'); setIsLearnOpen(false); setIsStoryOpen(false); setIsPracticeOpen(false); setIsToolkitsOpen(false); setIsResourcesOpen(false); setIsSoftwareOpen(false); setIsCareerOpen(false); setIsApiGuideOpen(false); setIsRagTrainingOpen(false) }
  useEffect(() => {
    const syncFocusedView = () => { setIsLearnOpen(window.location.hash === '#learn-hub'); setIsStoryOpen(window.location.hash === '#my-story'); setIsPracticeOpen(window.location.hash === '#practice-lab'); setIsToolkitsOpen(window.location.hash === '#qa-toolkits'); setIsResourcesOpen(window.location.hash === '#resources-hub'); setIsSoftwareOpen(window.location.hash === '#qa-software'); setIsCareerOpen(window.location.hash === '#career-paths'); setIsApiGuideOpen(window.location.hash === '#api-testing-guide'); setIsRagTrainingOpen(window.location.hash === '#rag-training') }
